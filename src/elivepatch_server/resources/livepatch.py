...
class PaTch(object):
    ...
    def get_kernel_sources(self, kernel_version, debug=True):
        ...
        try:
            _command(
                [
                    "git",
                    "clone",
                    "https://github.com/aliceinwire/gentoo-sources_overlay.git",
                ]
            )
        except:
        ...
        ebuild_path = os.path.join(
            "gentoo-sources_overlay",
            "sys-kernel",
            "gentoo-sources",
            "gentoo-sources-" + kernel_version + ".ebuild",
        )
...
def _command(bashCommand, kernel_source_dir=None, env=None):
    ...
    if kernel_source_dir:
        ...
        process = subprocess.Popen(
            bashCommand, stdout=subprocess.PIPE, cwd=kernel_source_dir, env=env
        )
